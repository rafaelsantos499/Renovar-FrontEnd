  ...
  >
    ...
    <div
      class="
        ...
        py-10
      "
      style="background-image: url('/public/media/misc/pattern-1.jpg')"
    >
      <!--begin::Title-->
    ...
    <div class="row g-0">
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg src="/public/media/icons/duotune/finance/fin009.svg" />
          </span>
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg src="/public/media/icons/duotune/communication/com010.svg" />
          </span>
      ...
      <div class="col-6">
        ...
        >
          <span class="svg-icon svg-icon-3x svg-icon-success mb-2">
            <inline-svg src="/public/media/icons/duotune/abstract/abs042.svg" />
          </span>

      ...
      <div class="card-toolbar">
        ...
        >
          <span class="svg-icon svg-icon-3">
            <inline-svg src="/public/media/icons/duotune/general/gen035.svg" />
          </span>
          Add new method</a
        >
      </div>
        ...
        <div class="py-3 d-flex flex-stack flex-wrap">
          ...
          >
            ...
            <div class="me-3 rotate-90">
              <span class="svg-icon svg-icon-3">
                <inline-svg src="/public/media/icons/duotune/arrows/arr071.svg" />
              </span>
            </div>
            <!--end::Arrow-->
            <!--begin::Logo-->
          ...
          <div class="d-flex my-3 ms-9">
            ...
            >
              ...
              <span class="svg-icon svg-icon-3">
                <inline-svg src="/public/media/icons/duotune/general/gen027.svg" />
              </span>
            </a>
            <!--end::Delete-->
            <!--begin::More-->
            ...
            >
              <span class="svg-icon svg-icon-3">
                <inline-svg src="/public/media/icons/duotune/general/gen019.svg" />
              </span>
            </a>
            <!--begin::Menu-->
            <div
                  ...
                  <tr>
                    ...
                    <td class="text-gray-800">
                      ...
                      <div class="symbol symbol-20px symbol-circle ms-2">
                        <img src="/public/media/flags/australia.svg" />
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-gray-800">
                      ...
                      <span class="svg-icon svg-icon-2 svg-icon-success">
                        <inline-svg
                          src="/public/media/icons/duotune/general/gen043.svg"
                        />
                      </span>
                    </td>
                  </tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-gray-800">
                      United Kingdom
                      <div class="symbol symbol-20px symbol-circle ms-2">
                        <img src="/public/media/flags/united-kingdom.svg" />
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-gray-800">
                      ...
                      <span class="svg-icon svg-icon-2 svg-icon-success">
                        <inline-svg
                          src="/public/media/icons/duotune/arrows/arr012.svg"
                        />
                      </span>
                    </td>
                  </tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-gray-800">
                      ...
                      <div class="symbol symbol-20px symbol-circle ms-2">
                        <img src="/public/media/flags/united-states.svg" />
                      </div>
                    </td>
                  </tr>
                  <tr>

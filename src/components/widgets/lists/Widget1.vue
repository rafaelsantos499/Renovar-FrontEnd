...
export default defineComponent({
  ...
  setup() {
    const items = [
      ...
      {
        icon: "/public/media/icons/duotune/art/art005.svg",
        color: "warning",
        title: "Concept Design",
        description: "Art Director",
      },
      {
        icon: "/public/media/icons/duotune/communication/com012.svg",
        color: "primary",
        title: "Functional Logics",
        description: "Lead Developer",
      },
      {
        icon: "/public/media/icons/duotune/coding/cod008.svg",
        color: "danger",
        title: "Development",
        description: "DevOps",
      },
      {
        icon: "/public/media/icons/duotune/general/gen049.svg",
        color: "info",
        title: "Testing",

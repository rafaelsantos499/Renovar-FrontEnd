...
export default defineComponent({
  ...
  setup() {
    const list = [
      {
        product: {
          image: "/public/media/stock/600x400/img-26.jpg",
      ...
      {
        product: {
          image: "/public/media/stock/600x400/img-3.jpg",
      ...
      {
        product: {
          image: "/public/media/stock/600x400/img-9.jpg",
      ...
      {
        product: {
          image: "/public/media/stock/600x400/img-18.jpg",
      ...
      {
        product: {
          image: "/public/media/stock/600x400/img-8.jpg",

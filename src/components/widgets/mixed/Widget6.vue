              ...
              <div class="symbol symbol-50px me-3">
                <div class="symbol-label bg-light-info">
                  <span class="svg-icon svg-icon-1 svg-icon-info">
                    <inline-svg src="/public/media/icons/duotune/art/art007.svg" />
                  </span>
                </div>
              </div>
              <!--end::Symbol-->
              ...
              <div class="symbol symbol-50px me-3">
                <div class="symbol-label bg-light-danger">
                  <span class="svg-icon svg-icon-1 svg-icon-danger">
                    <inline-svg src="/public/media/icons/duotune/abstract/abs027.svg" />
                  </span>
                </div>
              </div>
              <!--end::Symbol-->
              ...
              <div class="symbol symbol-50px me-3">
                <div class="symbol-label bg-light-success">
                  <span class="svg-icon svg-icon-1 svg-icon-success">
                    <inline-svg
                      src="/public/media/icons/duotune/ecommerce/ecm002.svg"
                    />
                  </span>
                </div>
              </div>
              ...
              <div class="symbol symbol-50px me-3">
                <div class="symbol-label bg-light-primary">
                  <span class="svg-icon svg-icon-1 svg-icon-primary">
                    <inline-svg
                      src="/public/media/icons/duotune/ecommerce/ecm010.svg"
                    />
                  </span>
                </div>
              </div>

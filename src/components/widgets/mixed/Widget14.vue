            ...
            <div class="symbol symbol-40px me-3">
              <div class="symbol-label bg-white bg-opacity-50">
                <span class="svg-icon svg-icon-1 svg-icon-dark">
                  <inline-svg src="/public/media/icons/duotune/abstract/abs043.svg" />
                </span>
              </div>
            </div>
            <!--end::Symbol-->
        ...
        <div class="col-6">
          <div class="d-flex align-items-center mb-9 ms-2">
            ...
            <div class="symbol symbol-40px me-3">
              <div class="symbol-label bg-white bg-opacity-50">
                <span class="svg-icon svg-icon-1 svg-icon-dark">
                  <inline-svg src="/public/media/icons/duotune/abstract/abs046.svg" />
                </span>
              </div>
            </div>
            <!--end::Symbol-->
        ...
        <div class="col-6">
          <div class="d-flex align-items-center me-2">
            ...
            <div class="symbol symbol-40px me-3">
              <div class="symbol-label bg-white bg-opacity-50">
                <span class="svg-icon svg-icon-1 svg-icon-dark">
                  <inline-svg src="/public/media/icons/duotune/abstract/abs022.svg" />
                </span>
              </div>
            </div>
            <!--end::Symbol-->
        ...
        <div class="col-6">
          <div class="d-flex align-items-center ms-2">
            ...
            <div class="symbol symbol-40px me-3">
              <div class="symbol-label bg-white bg-opacity-50">
                <span class="svg-icon svg-icon-1 svg-icon-dark">
                  <inline-svg src="/public/media/icons/duotune/abstract/abs045.svg" />
                </span>
              </div>
            </div>
            <!--end::Symbol-->

            ...
            <div class="pb-10">
              ...
              >
                <span class="svg-icon svg-icon-4x me-4">
                  <inline-svg src="/public/media/icons/duotune/coding/cod001.svg" />
                </span>
              ...
              >
                <span class="svg-icon svg-icon-4x me-4">
                  <inline-svg
                    src="/public/media/icons/duotune/communication/com003.svg"
                  />
                </span>
          ...
          <div :class="[state !== 'apps' && 'd-none']" data-kt-element="apps">
            ...
            >
              <span class="svg-icon svg-icon-2tx svg-icon-warning me-4">
                <inline-svg src="/public/media/icons/duotune/general/gen044.svg" />
              </span>
              <!--begin::Wrapper-->
